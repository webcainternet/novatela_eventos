		...
		<tbody>
		  ...
		  <tr>
			...
			<td class="text-right"><?php if ($product['price']) { ?>
			  ...
			  <?php } ?></td>
			<td class="text-right"><button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" title="<?php echo $button_cart; ?>" class="btn btn-primary"><span class="btninscrevase">Inscreva-se</span></button>
