			  ...
			  <tr>
				...
				<td class="text-left">
					<div class="input-group btn-block" style="max-width: 200px;">
						<p class="clearfix"><input style="display: none;" type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" class="form-control cart-q" id="cart-q" /><?php echo $product['quantity']; ?></p>
						<div>
