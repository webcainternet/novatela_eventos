                        ...
                        <div>
                            ...
                            <div class="right col-sm-8">
                                ...
                                <div class="cart-button">
                                    <button class="btn btn-add" data-toggle="tooltip" title="<?php echo $button_cart; ?>" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><span class="btninscrevase">Inscreva-se</span></button>
