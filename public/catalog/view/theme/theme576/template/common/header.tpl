...
<head>
    ...
    <script type="text/javascript" src="/catalog/view/theme/theme576/js/fancybox/jquery.fancybox.pack.js"></script>
    ...
    <header class="header">
        ...
        <div class="container">
            ...
            <address class="fa fa-phone">
                <a href="callto:#">(11) 5085-6000</a>
            </address>
        </div>
        <div class="stuck-menu-wrap">
