...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?>"><ul class="breadcrumb">
  ...
  <?php } ?><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset>
          ...
          <div class="form-group">
            <label class="col-sm-4 control-label" for="input-website"><?php echo $entry_website; ?></label>
            <div class="col-sm-8">
        ...
        <fieldset>
          ...
          <div class="form-group">
            <label class="col-sm-4 control-label" for="input-tax"><?php echo $entry_tax; ?></label>
            <div class="col-sm-8">
          ...
          <div class="form-group payment" id="payment-cheque">
            <label class="col-sm-4 control-label" for="input-cheque"><?php echo $entry_cheque; ?></label>
            <div class="col-sm-8">
          ...
          <div class="form-group payment" id="payment-paypal">
            <label class="col-sm-4 control-label" for="input-paypal"><?php echo $entry_paypal; ?></label>
            <div class="col-sm-8">
          ...
          <div class="payment" id="payment-bank">
            <div class="form-group">
              <label class="col-sm-4 control-label" for="input-bank-name"><?php echo $entry_bank_name; ?></label>
              <div class="col-sm-8">
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label" for="input-bank-branch-number"><?php echo $entry_bank_branch_number; ?></label>
              <div class="col-sm-8">
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label" for="input-bank-swift-code"><?php echo $entry_bank_swift_code; ?></label>
              <div class="col-sm-8">
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label" for="input-bank-account-name"><?php echo $entry_bank_account_name; ?></label>
              <div class="col-sm-8">
            ...
            <div class="form-group">
              <label class="col-sm-4 control-label" for="input-bank-account-number"><?php echo $entry_bank_account_number; ?></label>
              <div class="col-sm-8">
