...
<script type="text/javascript">
  $(document).ready(function(){
      $("#input-payment-custom-field2").mask("999.999.999-99");
      $("#input-payment-custom-field9").mask("99.999.999/9999-99");
      $("#input-payment-telephone").mask("(99) 9999-9999?9");
      $("#input-payment-postcode").mask("99999-999");
      $("#input-payment-custom-field6").mask("99/99/9999");

  });
</script>

<script type="text/javascript">
    //Verificar seleção e mostrar os que devem
    $( document ).ready(function() {

        $("input:radio[name=custom_field\\[account\\]\\[1\\]]").change(function(){
            if ($('input:radio[name=custom_field\\[account\\]\\[1\\]]:checked').val() == 1) {
              clearcampos();
              $( ".camponome" ).show();
              $( "#lbnomepessoa" ).show();
              $( "#payment-custom-field6" ).show();
              $( "#payment-custom-field2" ).show();
              $( "#payment-custom-field3" ).show();
              $( "#input-payment-custom-field9").val('00000000');
              ...
              $( ".camponome" ).show();
              $( "#lbnomeempresa" ).show();
              $( "#payment-custom-field5" ).show();
              $( "#payment-custom-field9" ).show();
              $( "#payment-custom-field10" ).show();
              $( "#payment-custom-field5" ).css('display', 'block !important');
              $( "#payment-custom-field9" ).css('display', 'block !important');
              $( "#payment-custom-field10" ).css('display', 'block !important');
              $( "#input-payment-custom-field2").val('00000000');
              $( "#input-payment-custom-field9").val('');
            }
        });
    });
</script>
  ...
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group required camponome">
        <label class="control-label" for="input-payment-firstname" id="lbnomepessoa">Nome completo</label>
        <label class="control-label" for="input-payment-firstname" id="lbnomeempresa">Nome da empresa</label>
        <input type="text" name="firstname" value="" placeholder="Digite..." id="input-payment-firstname" class="form-control" />
      </div>
      ...
      <div class="form-group campoempresa">
        ...
        <input type="text" name="company" value="" placeholder="<?php echo $entry_company; ?>" id="input-payment-company" class="form-control" />
					...
					<div class="form-group required">
						...
						<input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-payment-postcode" autocomplete="off" class="form-control" />
					</div>
...
<div class="buttons clearfix">
  <div class="pull-right">
    ...
    Eu li e concordo com o contrato de <a target="_blank" class="iframe" href="/contrato" alt="Politica de Privacidade"><b>Politica de Privacidade</b></a>
...
<script type="text/javascript">
  function clearcampos() {
    ...
    $( "#lbnomeempresa" ).hide();
    $( ".camponome" ).hide();
    $( "#payment-custom-field6" ).hide();
    $( "#payment-custom-field5" ).hide();
    $( "#payment-custom-field9" ).hide();
    $( "#payment-custom-field10" ).hide();
    $( "#payment-custom-field2" ).hide();
    $( "#payment-custom-field3" ).hide();
    $( "#payment-custom-field8" ).hide();
  } clearcampos();
</script>

<style type="text/css">
  #payment-custom-field9 {display: none; }
  #payment-custom-field10 {display: none ; }
