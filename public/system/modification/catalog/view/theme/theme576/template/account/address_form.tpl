            ...
            <div class="col-sm-10">
              <input type="text" name="company" value="<?php echo $company; ?>" placeholder="<?php echo $entry_company; ?>" id="input-company" class="form-control" />
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
						  <input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-postcode" autocomplete="off" class="form-control" />
...
<!-- 
 ...
 -->
          ...
          <div class="form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" id="grp<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order']; ?>">
...
<script type="text/javascript">
    ...
    $("#grp8").css( "display", "none" );
    /*
    if ($('input:radio[name=custom_field\\[1\\]]:checked').val() == 1) {
      $("#separado9").css( "display", "none" );
      $("#separado10").css( "display", "none" );
      $("#separado5").css( "display", "none" );
    }
    if ($('input:radio[name=custom_field\\[1\\]]:checked').val() == 2) {
      $("#separado2").css( "display", "none" );
      $("#separado3").css( "display", "none" );
      $("#separado6").css( "display", "none" );
    }
    */
