...
$mysqli = new mysqli(DB_HOSTNAME, DB_USERNAME, DB_PASSWORD, DB_DATABASE);
	...
	//Consulta
	$sql = "SELECT p.product_id, op.product_option_id, od.name FROM oc_product p INNER JOIN oc_product_option op ON p.product_id = op.product_id INNER JOIN oc_option_description od ON od.option_id = op.option_id WHERE od.name in ('Celular', 'CPF', 'E-Mail', 'Nome Completo') AND p.product_id = ".$product_id;
	...
	if ($result = $mysqli->query($sql)) { 
		...
		if ($row_cnt > 0) {
	        ...
	        while($obj = $result->fetch_object()){
	        	if ($obj->name == 'Celular') {
	        		echo '$("#input-option'.$obj->product_option_id.'").mask("(99) 9999-9999?9");';
	        	}

	        	if ($obj->name == 'CPF') {
	        		echo '$( "#input-option'.$obj->product_option_id.'" ).mask("999.999.999-99");';
	        		echo '$( "#input-option'.$obj->product_option_id.'" ).change(function() { validarCPF( "input-option'.$obj->product_option_id.'" ); });';
	        	}

	        	if ($obj->name == 'E-Mail') {
	        		echo '$( "#input-option'.$obj->product_option_id.'" ).change(function() { validarEmail( "input-option'.$obj->product_option_id.'" ); });';
	        	}

	        	if ($obj->name == 'Nome Completo') {
	        		echo '$( "#input-option'.$obj->product_option_id.'" ).change(function() { validarNome( "input-option'.$obj->product_option_id.'" ); });';
	        	}
        	}
    	}
	}
			...
			<div class="<?php echo $content_right; ?> product_page-right">
				<div class="general_info product-info">
					...
					<div class="price-section">
						...
						<?php if (!$special) { ?>
						<span class="price-new">         <div class="opprice"><?php echo $price; ?></div>
                                            </span>
						<?php } else { ?>
						<span class="price-old"><?php echo $price; ?></span>
						<?php } ?>
						<?php if ($tax) { ?>
						<span class="tax"><?php echo $text_tax; ?> <div class="price-tax"><?php echo $tax; ?></div></span>
						<?php } ?>
					...
					<ul class="list-unstyled product-section">
						...
						<?php if ($stock == "Inscrições encerradas") { ?>
							<br>&nbsp;<br><span style="font-size: 24px; background-color: #ED3426; color: #FFF; padding: 5px;"><?php echo $stock; ?></span>
						<?php }  else { ?>
							<br>&nbsp;<br><span style="font-size: 24px; background-color: #4DBB42; color: #FFF; padding: 5px;"><?php echo $stock; ?></span>
						<?php } ?>
					...
					<div class="form-group form-horizontal">
						<div class="form-group">
							<div style="display: none;">
								...
								<div class="col-sm-2">
									               <input id='bc' type="text" name="quantity"  value="<?php echo $minimum; ?>" size="2" id="input-quantity" class="form-control" />
								</div>
							</div>
						</div>
						
						<input type="hidden" name="product_id" value="<?php echo $product_id; ?>" />
						<button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="product-btn-add">Inscreva-se</button>
					</div>
