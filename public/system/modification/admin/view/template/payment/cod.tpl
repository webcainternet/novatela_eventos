      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-cod" class="form-horizontal">
          <div class="form-group">
			...
			<div class="form-group">
            <label class="col-sm-2 control-label" for="input-total-max"><span data-toggle="tooltip" title="<?php echo $entry_total_max_help; ?>"><?php echo $entry_total_max; ?></span></label>
            <div class="col-sm-10">
              <input type="text" name="cod_total_max" value="<?php echo $cod_total_max; ?>" placeholder="<?php echo $entry_total_max; ?>" id="input-total-max" class="form-control" />
            </div>
          </div>
