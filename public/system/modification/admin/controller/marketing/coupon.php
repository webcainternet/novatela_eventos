...
$data['import'] = $this->url->link('sale/coupon', 'token=' . $this->session->data['token'], 'SSL');$data['importcsv'] = $this->url->link('sale/couponcsv', 'token=' . $this->session->data['token'], 'SSL');$data['deleteall'] = $this->url->link('sale/coupon/deleteAll', 'token=' . $this->session->data['token'], 'SSL');
