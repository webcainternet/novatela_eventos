...
class ControllerPaymentCod extends Controller {
	...
	public function index() {
		...
		$data['entry_order_status'] = $this->language->get('entry_order_status');
			...
			$data['entry_total_max_help'] = $this->language->get('entry_total_max_help');
		...
		$data['cancel'] = $this->url->link('extension/payment', 'token=' . $this->session->data['token'], 'SSL');
			...
			if (isset($this->request->post['cod_total_max'])) {
				$data['cod_total_max'] = $this->request->post['cod_total_max'];
			} else {
				$data['cod_total_max'] = $this->config->get('cod_total_max'); 
			}
