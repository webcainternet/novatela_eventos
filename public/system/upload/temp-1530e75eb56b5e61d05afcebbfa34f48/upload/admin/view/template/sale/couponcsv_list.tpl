        ...
        <div class="panel panel-default">
          ...
          <div class="panel-collapse collapse" id="collapse-import-coupon">
            <div class="panel-body">
               <form class="form-horizontal">
               <div class="form-group">
                   <label class="col-sm-2 control-label" for="input-stock-status"><?php echo $text_export; ?></label>
                    <div class="col-sm-10">
                      <button type="button" class="btn btn-primary btn-lg" onclick="location = '<?php echo $exportct; ?>'"><?php echo $button_export; ?></button>
                   </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label"><?php echo $text_import; ?></label>
                      <div class="col-sm-10">
                        <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal1"><?php echo $button_import; ?></button>
                    </div>
                </div>
              </form>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form action="<?php echo $importct; ?>" method="post" enctype="multipart/form-data" id="csvform">
...
var customergroup = $('input[name = "imdevcoupon_customergroup"]:checked').map(function() {
  ...
  $.ajax({
    type: 'post',
    data: 'prefix=' + prefix + '&number=' + number + '&ctype=' + ctype + '&discount=' + discount + '&shipamount=' + shipamount + '&freeshipping=' + freeshipping + '&logged=' + logged + '&customergroup=' + customergroup + '&total=' + total + '&sdate=' + sdate + '&edate=' + edate + '&usetotal=' + usetotal + '&cuse=' + cuse + '&ccat=' + ccat  + '&pid=' + pid,
  url: 'index.php?route=sale/coupon/setting&token=<?php echo $token; ?>',
  dataType: 'json',
  success: function(data) {
       $('#collapse-import-coupon').parent().find('.panel-heading .panel-title').html('<a href="#collapse-import-coupon" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle">Step 2: Download the sheet using export button, add coupon code and upload using import button </a>');
...
$(document).ready(function() {
      $('#collapse-checkout-option').parent().find('.panel-heading .panel-title').html('<a href="#collapse-checkout-option" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle">Step 1: Fill form below to save your coupon settings</a>');
