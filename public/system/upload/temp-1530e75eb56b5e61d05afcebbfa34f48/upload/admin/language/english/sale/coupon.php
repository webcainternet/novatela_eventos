<?php
// Heading  
$_['heading_title']       = 'Automatic Import Coupon With Form';
$_['heading_titlecsv']       = 'Import Coupon With Csv Sheet';
...
$_['text_export']       = 'Export Sheet';

$_['button_import']    = 'Import Coupons From Downloaded Sheet';
$_['text_import']       = 'Import Sheet';
...
$_['helpContent']  = '<ol>
<li> Download coupon template sheet for your reference</li>
<li>Open CSV sheet and add your settings.</li>
<li>While modifying CSV Template, please note:
<ol type="i"><li>Dont leave name and code column empty</li>
<li>All codes needs to be unique. If you modify make sure it is unique.</li>
