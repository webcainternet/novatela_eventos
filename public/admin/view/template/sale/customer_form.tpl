...
function addAddress() {
	...
	html += '  <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" id="grpfield custom-field<?php echo $custom_field['custom_field_id']; ?>"">';
